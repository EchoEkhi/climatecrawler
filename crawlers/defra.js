...
async function defra() {
    ...
    try {
        ...
        stertStreet = $('tr')[19].childNodes[5].firstChild.data

    } catch (e) {

        log.warn('[defra] Stert Street data fetch failed!')
        log.warn(e)
    ...
    try {
        ...
        highStreet = $('tr')[19].childNodes[5].firstChild.data
        defrapm10at18 = $('tr')[19].childNodes[9].firstChild.data

        log.info('[defra] Complete')

    } catch (e) {

        log.warn('[defra] High Street data fetch failed!')
        log.warn(e)
